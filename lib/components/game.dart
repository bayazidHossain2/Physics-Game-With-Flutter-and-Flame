...
class MyPhysicsGame extends Forge2DGame {
  ...
  void update(double dt) {
    ...
    print('$isMounted $enemiesFullyAdded ${world.children.whereType<Enemy>().isEmpty} ${world.children.whereType<TextComponent>().isEmpty}');
    if (isMounted &&
        enemiesFullyAdded &&
    ...
    for (var i = 0; i < 3; i++) {
      await world.add(
        Enemy(
          ...
          aliens.getSprite(EnemeyColor.randomColor.fileName),
        ),
      );
